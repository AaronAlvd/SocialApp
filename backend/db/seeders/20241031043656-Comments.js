...
module.exports = {
  async up (queryInterface, Sequelize) {
   await Comment.bulkCreate([
    ...
    {
      id: 'g7e6b9c3-8f1d-4b7a-9c4f-3e6d5b2c4a5d',
      userId: 'e0fbe97e-9aa7-4733-a7ea-65a6ddbf53d2', // Emily Nguyen
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `This looks incredible! You've got a real eye for detail. 👍`
    },
    {
      id: 'h5d9f3b1-7e2a-4c3d-9f7e-6a4b5d8c9e0f',
      userId: 'f9d6b7e2-4d56-4ab3-b47d-f8a0e8ec9a15', // Noah Kim
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `Love the aesthetics of this! Colors are really well-chosen. 🎨👌`
    },
    {
      id: 'i6f4e2b7-3c8d-4a9f-9d2e-7c1a6f5b3d4e',
      userId: 'b4d7ae0a-3c91-4b5d-85ab-55d07eecf7c6', // Ava Patel
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `Wow, this design is so refreshing! Keep up the great work! 🚀`
    },
    {
      id: 'j7a5f3c2-4e9d-4b6e-9f1c-3d8f2c5a7b0e',
      userId: 'c2b45d83-1e6c-41f4-9a5e-2f58b9ec27d9', // Mia Robinson
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `This is so impressive, James! You nailed the vibe perfectly. 🌟`
    },
    {
      id: 'k9f8b3c4-2e1d-4a7f-8c6b-3d1a5f2b9e7d',
      userId: 'e7a9eaf2-7dd3-49d5-93f2-1e4f5d2a8c7e', // Lucas Rivera
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `Stunning work! This is exactly the kind of creativity we need. 🙌🔥`
    },
    {
      id: 'm1e9b2f4-7a5c-4d8e-9f3b-6d2f5c1b4e7d',
      userId: 'd6f12a4e-549b-42c9-8a8e-47f4c6aefc56', // Isabella Lopez
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `The layout and colors are on point! Can't wait to see more. 🌈`
    },
    {
      id: 'n2c8f5b1-3d4e-4f9a-8c7e-5a1b2d9f4e6c',
      userId: 'a6b72c2f-3f5e-4b6b-91e4-774c8e5b4d13', // Sophia Lin
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `You've got such a unique style, James! Loving this design. 💯`
    },
    {
      id: 'o7f6e1b9-4a3d-4c2f-8b9d-7a5e3f2c6d0b',
      userId: 'f8d8e7b3-4d78-4ab3-9b1a-1c6e5a1d7e8f', // Ethan Young
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `This is really inspiring! Keep pushing the boundaries! 💡👏`
    },
    {
      id: 'p6e3b4c2-7f1d-4a8e-9b5c-8f2a6e1d4b0c',
      userId: 'c9f6f4a1-4d3f-4aeb-8e32-5c8c3c1d6f34', // Lily Brooks
      postId: 'p1d1c0d8-99e0-4a52-b5ae-78a7e0c00b01',
      comment: `Looks amazing! The creativity here is just next level. 🌠`
    }
    // {

...
const readImage = (filePath) => {
  return new Promise((resolve, reject) => {
    fs.readFile(filePath, (err, data) => {  // Correct callback syntax
      if (err) {
...
module.exports = { users01, users01_id }